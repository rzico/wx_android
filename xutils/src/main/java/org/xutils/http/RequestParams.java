...
import org.xutils.http.body.ListParam;
import org.xutils.http.body.ListParamsBody;
...
public class RequestParams {
     ...
     * @param value
     */
    public void addListParameter(String name, String value) {
        if (this.listParams == null) {
            this.listParams = new ArrayList<ListParam>();
        }
    ...
    public RequestBody getRequestBody() throws IOException {
        ...
        } else if (this.listParams != null && this.listParams.size() > 0) {
            result = new ListParamsBody(this.listParams ,charset);
        }
