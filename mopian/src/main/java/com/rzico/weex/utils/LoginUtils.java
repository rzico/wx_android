...
public class LoginUtils  {
    ...
    public static void checkLogin(BaseActivity activity,final Intent intent,final OnLoginListener listener) {
        new XRequest(activity, "/farmer/login/isAuthenticated.jhtml", XRequest.POST, new HashMap<String, Object>()).setOnRequestListener(new HttpRequest.OnRequestListener() {
            @Override
...
//                                发起聊天
                                ...
                                if(MzSystemUtils.isBrandMeizu(WXApplication.getContext())){
                                    com.meizu.cloud.pushsdk.PushManager.register(activity, Constant.mzpushAppId, Constant.mzpushAppKey);
                                }
