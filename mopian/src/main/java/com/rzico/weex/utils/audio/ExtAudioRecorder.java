package com.rzico.weex.utils.audio;
...
public class ExtAudioRecorder 
{
    ...
    public static ExtAudioRecorder getInstanse(Boolean recordingCompressed)
    {
        ...
        if(extAudioRecorder == null){
            ...
            {
                extAudioRecorder = new ExtAudioRecorder(    false,
                        AudioSource.MIC,
                        sampleRates[3],
            ...
            else
            {
                ...
                } while((++i<sampleRates.length) & !(extAudioRecorder.getState() == ExtAudioRecorder.State.INITIALIZING));
            }
        }else {
    ...
    */
    ...
    public void start(JSCallback callback)
    {
        if (state == State.READY)
        {
            ...
            callback.invoke(new Message().success("开始录音"));
