...
//            为了阿轲测试注释
            if (Utils.isApkDebugable(SplashActivity.this)) {
                downloadFile( "http://cdn.rzico.com/weex/resources/release/laiya-0.0.1.zip?t=" + System.currentTimeMillis(), PathUtils.getResPath(SplashActivity.this) + "update_net.zip");
