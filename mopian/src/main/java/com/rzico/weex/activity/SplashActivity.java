...
//            为了阿轲测试注释
            if (Utils.isApkDebugable(SplashActivity.this)) {
                downloadFile("http://mopian.oss-cn-hangzhou.aliyuncs.com/weex/release/res-0.0.0.zip" + "?t=" + System.currentTimeMillis(), PathUtils.getResPath(SplashActivity.this) + "update_net.zip");
