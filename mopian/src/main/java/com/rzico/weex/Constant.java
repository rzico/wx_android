...
public class Constant {
    ...
    //这里的WEEX_CATEGORY 需要与配置文件中的意图配置统一： <category android:name="com.taobao.android.intent.category.LEQUDONG" />
    public static final String WEEX_CATEGORY = "com.taobao.android.intent.category.LEQUDONG";
    public static final String WEEX_ACTION = "com.taobao.android.intent.action.LEQUDONG";
...
//    public static  String center = "view/member/editor/editor.js";
    ...
    //生产环境服务器地址
    public static final String SERVER = "https://m.lequdong.com/";
    ...
    public static long mzpushbussid;
    public static long huaweibussid;
    public static long mipushbussid;
