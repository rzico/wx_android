...
import com.rzico.weex.zhibo.view.utils.VideoMaterialDownloadProgress;
...
//    };
    ...
    private SharedPreferences mPrefs = PreferenceManager.getDefaultSharedPreferences(WXApplication.getContext());
