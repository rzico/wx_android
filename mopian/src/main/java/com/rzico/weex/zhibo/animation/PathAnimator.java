...
public class PathAnimator extends AbstractPathAnimator {
    ...
    public int type=0;
    public PathAnimator(Config config, int type) {
        super(config);
    ...
    public void start(final View child, final ViewGroup parent) {
        ...
        FloatAnimation anim = new FloatAnimation(createPath(mCounter, parent, 2), randomRotation(), parent, child,type);
    ...
    static class FloatAnimation extends Animation {
        ...
        public FloatAnimation(Path path, float rotation, View parent, View child, int type) {
