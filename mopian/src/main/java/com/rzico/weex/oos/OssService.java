...
//                UIDisplayer.displayInfo(info);
    ...
    public void asyncPutImage(String object, String localFile, final JSCallback callback, final JSCallback progressCallback) {
        if (object.equals("")) {
        ...
        final String imagePath = put.getObjectKey();
        // 异步上传时可以设置进度回调
        ...
        OSSAsyncTask task = oss.asyncPutObject(put, new OSSCompletedCallback<PutObjectRequest, PutObjectResult>() {
            ...
            public void onSuccess(PutObjectRequest request, PutObjectResult result) {
                ...
                if(callback!=null){
                    ...
                    message.setContent("success");
                    message.setType("success");
                    message.setData(Constant.resURL + imagePath);
                    callback.invoke(message);
                }
