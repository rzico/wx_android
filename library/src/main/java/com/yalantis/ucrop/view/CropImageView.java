...
public class CropImageView extends TransformImageView {
     ...
     * 取消所有当前动画并设置图像以填充作物区域（无动画）。然后创建并执行{@链接BitmapCropTask }适当的参数。
     */
     ...
     * 更新当前作物矩形与给定。也重新计算图像的特征和位置，以适应新的作物矩形。
     *
     ...
     * 如果图像不能填充作物边界，必须对其进行翻译和缩放以填充这些图像。
     * <p/>
     ...
     * 只有在将图像转换为作物边界矩形中心时，图像才能填充作物边界，才能计算尺度值。使用临时变量此方法检查此情况。
     */
